...
- Serve: click or press Space once to start the serve meter, then click or press Space again to choose the meter position and serve. The serve meter clears when the rally starts.
...
- Neon arcade HUD with a serve/shot speedometer, live serve meter that resets for rallies, energy meter, combo counter, rally counter, and animated PERFECT RETURN, MEGA SMASH, POWER READY, and FLAME SMASH callouts.
- 3D tennis court built with React, Vite, Three.js, and React Three Fiber.
- Player-vs-AI rallies against Hidalgo.
- Tennis-style points, games, sets, serving turns, second serves, double faults, and timing-based player serve outcomes.
