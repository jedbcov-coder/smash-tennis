...
- Serve: click or press Space once to start the serve meter, then click or press Space again to choose the meter position and hit the serve. The HUD shows the moving meter and then labels the result as Weak Serve, Standard Serve, Perfect Serve, Power Serve, or Fault.
